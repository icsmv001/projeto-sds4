...
const DataTableProcessos12b = () => {
  ...
  useEffect(() => {
    ...
    // endpoint com passagem de parametros.
    // http://localhost:8080/LogDashBoardProcessamentosPage/buscarDetalhamentoPorParametros?id_estrutura=3221&data=25/07/2024&page=0&size=10

    axios
      .get(
        `${BASE_URL}/LogDashBoardProcessamentosPage/buscarDetalhamentoPorParametros?page=${activePage}&size=300&id_estrutura=3221&data=25/07/2024`
